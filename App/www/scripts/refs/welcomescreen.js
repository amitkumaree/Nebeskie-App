...
Framework7.prototype.plugins.welcomescreen = function (app, globalPluginParams) {
    ...
    Welcomescreen = function (slides, options) {
         ...
         */
        function initSwiper() {
            swiper = new Swiper('.swiper-container.welcomescreen-swiper', {
        ...
        function defineDefaultTemplate() {
            defaultTemplate = '<div id="ws_wrapper" class="welcomescreen-container {{#if options.cssClass}}{{options.cssClass}}{{/if}}">' +
